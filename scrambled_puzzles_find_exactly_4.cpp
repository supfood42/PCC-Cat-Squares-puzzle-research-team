...
bool dfs(int pos)
{
    ...
    if (pos == n * n)
    {
        ...
        if (solution_count <= 4)
            saved_solutions.push_back(board);

        return solution_count >= 5;
    }
...
int main(int argc, char* argv[])
{
    try
    {
             ...
             puzzle_index++)
        {
            ...
            const bool exceeded_four = dfs(0);
            ...
            else if (solution_count == 4)
            {
                     ...
                     solution_index++)
                {
                    ...
                    print_solution(saved_solutions[solution_index]);
                }
